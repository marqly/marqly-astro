/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2e4a7eeb8de0c9f5e3735d9c2a6130b2)
...
interface __BaseEnv_Env {
	...
	AI: Ai;
	ASSETS: Fetcher;
	ONETAP_EXCHANGE_SECRET: string;
	MARQLY_API_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ONETAP_EXCHANGE_SECRET" | "MARQLY_API_URL">> {}
}
