---
lang: "de"
path: "/de/recherche-organisieren"
title: "Eine Recherche organisieren"
seoTitle: "Recherche für ein Projekt organisieren, ohne Quellen zu verlieren | Marqly"
description: "Quellen mit einem Klick sichern, von der KI taggen und zusammenfassen lassen, jedes Projekt in einem Board bündeln und jedes Dokument beschreibend zurückholen."
eyebrow: "Recherche"
hero:
  heading: "Recherchieren ist leicht. Wiederfinden, was du recherchiert hast, nicht"
  subheading: "Ein Board je Projekt, automatische Tags und Zusammenfassungen, Suche nach Bedeutung über Seiten, Markierungen und Transkripte."
crumbHome: "Startseite"
trustLine: "Kostenlose Stufe, ohne Karte · Chrome, Edge, Firefox, Safari & iOS"
faqHeading: "Häufige Fragen"
faqs:
  - q: "Kann ich die Recherche nach Projekt trennen?"
    a: "Ja, über Boards. Jedes Projekt hat seines, und du kannst es als öffentliche Seite veröffentlichen, wenn du Quellen teilen musst."
  - q: "Muss ich jede Quelle taggen?"
    a: "Nein. Die KI taggt jede Speicherung automatisch. Eigene Tags kannst du ergänzen, brauchst du zum Wiederfinden aber nicht."
  - q: "Sucht es im Inhalt?"
    a: "Ja. Die semantische Suche erfasst den Seitentext, deine Markierungen und die Transkripte gespeicherter Videos."
  - q: "Taugt es, wenn die Recherche Monate dauert?"
    a: "Genau dafür ist es gedacht. Je länger das Projekt, desto stärker fällt ins Gewicht, sich nicht erinnern zu müssen, wo etwas liegt."
  - q: "Kann ich eine Seite bewahren, bevor sie sich ändert?"
...
Eine Recherchesitzung endet mit fünfzehn offenen Tabs, die du dich nicht zu schließen traust. Du kannst sie [alle auf einmal speichern](/de/tabs-speichern) und auch die ganze Sitzung sichern, um drei Tage später exakt dort weiterzumachen.
...
Kostenloses Konto ohne Karte auf [app.marqly.com](https://app.marqly.com). Leg das Projekt-Board an, bevor du zu suchen beginnst, speichere alles dort ohne zu sortieren und markier nur, was du nutzen wirst. Beim Schreiben suchst du beschreibend.

Wenn deine Arbeit akademisch ist: [Marqly für Forschende](/de/fuer-forschende); wenn journalistisch: [Marqly für Redaktionen](/de/fuer-journalisten).
