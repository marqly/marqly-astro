---
lang: "de"
path: "/de/rezepte-organisieren"
title: "Gespeicherte Rezepte organisieren"
seoTitle: "Rezepte aus dem Internet organisieren | Marqly"
description: "Rezepte verteilt zwischen Instagram, Screenshots und Lesezeichen. Alles an einem Ort, mit automatischen Tags und Suche nach Zutat oder Erinnerung."
eyebrow: "Rezepte"
hero:
  heading: "Du hast das Rezept gespeichert. Donnerstag um acht findest du es nicht"
  subheading: "Bring zusammen, was du aus Instagram, YouTube und Blogs speicherst — in einer Bibliothek mit automatischen Tags, durchsuchbar über eine Beschreibung."
crumbHome: "Startseite"
trustLine: "Kostenlose Stufe, ohne Karte · Chrome, Edge, Firefox, Safari & iOS"
faqHeading: "Häufige Fragen"
faqs:
  - q: "Kann ich Rezepte von Instagram oder TikTok speichern?"
    a: "Du kannst den Link des Beitrags speichern und ihn vom Handy an Marqly teilen. So liegt er nicht mehr nur in der Sammlung dieser App."
  - q: "Kann ich nach Zutat suchen?"
    a: "Du kannst beschreibend suchen, auch nach Zutaten, sofern sie auf der Seite oder im Transkript des Videos vorkommen."
  - q: "Und Rezepte, die YouTube-Videos sind?"
    a: "Beim Speichern des Videos wird das Transkript angehängt und durchsuchbar, und du hast Zusammenfassung und synchronisiertes Transkript auf der Seite selbst."
  - q: "Kann ich eine Rezeptliste teilen?"
    a: "Ja. Ein Board wird als öffentliche Seite veröffentlicht und per Link ohne Anmeldung geöffnet."
  - q: "Taugt es für den Wocheneinkauf?"
    a: "Du kannst die Rezepte der Woche in einem Board bündeln und es am Handy über die iPhone-App oder den Browser öffnen."
  - q: "Was kostet es?"
...
Wenn deine Rezepte vor allem über Messenger kommen, steht das in [später lesen](/de/spaeter-lesen).
...
Beim Speichern wird das Transkript angehängt: Monate später findest du das Video über eine Zutat, die darin nur **erwähnt** wird. Ohne Installation testen: [YouTube-Zusammenfassung](/de/tools/youtube-zusammenfassung).
