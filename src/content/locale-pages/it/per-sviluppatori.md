...
faqs:
  - q: "C'è un'API pubblica?"
    a: "No. Marqly non ha un'API pubblica e non è self-hosted. Se per te è un requisito, meglio saperlo prima."
...
È qui che cambia l'abitudine. La ricerca semantica ti lascia scrivere il problema come lo ricordi:

> «quella cosa dell'errore di certificato mentre buildavo l'immagine docker su macOS»

Senza il titolo della issue né il nome del repository. La ricerca copre il contenuto della pagina, le tue evidenziazioni e le trascrizioni dei video salvati.
...
Un talk di 45 minuti ha di solito sei minuti utili. Marqly mostra sulla pagina del video un riassunto, la trascrizione sincronizzata e una chat sul contenuto, e al salvataggio allega la trascrizione per farti cercare ciò che è stato *detto*.
...
Account gratuito e senza carta su [app.marqly.com](https://app.marqly.com). Installa l'estensione e per due settimane salva ogni pagina che ti sblocca, senza classificare. La prima volta che recuperi una soluzione descrivendola, non torni più indietro.
