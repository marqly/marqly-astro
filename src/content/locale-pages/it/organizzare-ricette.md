---
lang: "it"
path: "/it/organizzare-ricette"
title: "Organizzare le ricette salvate"
seoTitle: "Come organizzare le ricette trovate su internet | Marqly"
description: "Ricette sparse tra Instagram, screenshot e preferiti. Tutto in un posto, con tag automatici e ricerca per ingrediente o per ciò che ricordi."
eyebrow: "Ricette"
hero:
  heading: "La ricetta l'hai salvata. Giovedì alle otto non la trovi"
  subheading: "Riunisci ciò che salvi da Instagram, YouTube e blog in una libreria con tag automatici, consultabile descrivendo il piatto."
crumbHome: "Home"
...
faqs:
  ...
  - q: "Posso cercare per ingrediente?"
    a: "Puoi cercare descrivendo ciò che ricordi, ingredienti compresi, purché compaiano nella pagina o nella trascrizione del video."
  - q: "E le ricette che sono video di YouTube?"
    a: "Salvando il video, la trascrizione viene allegata e diventa ricercabile, e hai riassunto e trascrizione sincronizzata sulla pagina stessa."
  - q: "Posso condividere una lista di ricette?"
    a: "Sì. Una bacheca si pubblica come pagina pubblica che si apre dal link, senza registrazione."
  - q: "Serve per la spesa settimanale?"
    a: "Puoi raggruppare le ricette della settimana in una bacheca e aprirla dal telefono con l'app iPhone o dal browser."
  - q: "Quanto costa?"
...
- **Salvataggi di Instagram**, mescolati a meme e vestiti.
- **Screenshot in galleria**, senza alcun contesto.
- **Preferiti del browser**, in una cartella «cucina» con 200 link.
- **Video di YouTube** in «guarda più tardi».
- **Link che ti hanno mandato.**
...
Metà delle ricette in rete oggi sono video. E il problema del video è che per sapere se va bene devi guardarlo tutto o indovinare dalla miniatura.

Marqly mostra direttamente sulla pagina di YouTube:

- **Riassunto** del contenuto, per conoscere ingredienti e tempi.
