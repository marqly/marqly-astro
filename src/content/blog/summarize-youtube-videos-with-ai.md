---
title: "How to Summarize YouTube Videos with AI (Right on the Watch Page)"
...
faqs:
  ...
  - q: "Is the Marqly YouTube AI summary free?"
    a: "Yes to start. The extension is free to install on Chrome, Edge, Firefox, and Safari, and includes free AI summaries so you can try it on real videos. Marqly Pro unlocks chat with videos and heavier use — it costs $72 per year, which works out to about $6 per month billed annually."
...
Text doesn't have this problem. You can skim an article's intro and headers in fifteen seconds and know whether to commit — it's why [read-it-later apps](/blog/best-read-it-later-apps-2026) work so well for written content. Video gives you nothing to skim. Chapters help when creators bother to add them; most don't.
...
2. Select and copy the transcript text. (There's no copy-all button, so you're scroll-selecting — here's the full walkthrough on [getting a YouTube video transcript](/blog/how-to-get-youtube-video-transcript).)
...
4. **Go deeper if the video earns it.** The Chat tab lets you ask questions about the video with answers grounded in the transcript — starter question chips get you going, and you can interrogate a claim before deciding to watch. (Chat is a Pro feature; here's a full guide to [chatting with YouTube videos](/blog/chat-with-youtube-videos).) The Transcript tab shows the full transcript synced to playback — the current segment highlights as the video plays — with one-click copy.
5. **Save the good ones.** Marqly adds a **Bookmark** button to YouTube's own action row, next to Like and Share. Saving stores the video in your Marqly library with the transcript attached, so months later you can [find it by describing what it was about](/blog/how-to-search-bookmarks-with-ai) — no title or channel name required.
...
| | ChatGPT copy-paste | Summarizer sites | On-page extension (Marqly) |
|---|---|---|---|
| Steps per video | ~6 manual steps | 3–4 (copy URL, paste, wait) | 0 — open the video |
| Where the summary lives | A chat thread in another tab | Someone else's website | On the watch page, next to the video |
| Chat follow-ups | ✅ in the chat thread | ❌ mostly static text | ✅ grounded in the transcript (Pro) |
| Transcript access | Manual copy from YouTube | ⚠️ varies by site | ✅ synced to playback, one-click copy |
...
One more mark of a good system: the summary shouldn't evaporate. If you triage a video, decide it's worth keeping, and save it, the summary and transcript should come with it — that's what turns a [black-hole Watch Later list](/blog/save-youtube-videos-watch-later) into a library you can actually search.
...
It's free to install on Chrome, Edge, Firefox, and Safari, with free AI summaries to start. Marqly Pro unlocks chat with videos and heavier use — $72/year (about $6/month billed annually).

Open the next long video on your list and read the summary before you commit the 40 minutes.

---

*Related: [How to Save YouTube Videos to Watch Later](/blog/save-youtube-videos-watch-later) · [Chat with YouTube Videos](/blog/chat-with-youtube-videos)*
