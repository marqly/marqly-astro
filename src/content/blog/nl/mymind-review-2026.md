...
What's *not* here matters too: no in-page highlighter (saving a quote means clipping it, not [highlighting text](/nl/blog/tekst-markeren-op-elke-website-2026) directly on the live page), no YouTube summaries or transcripts, no public sharing, no team features, and no API.

## Prijzen (geverifieerd augustus 2026)
...
- **Import and export are thin.** Moving years of bookmarks into mymind is clumsy compared to tools built for [migrating existing saves](/nl/blog/pocket-alternatieven-2026).

## mymind vergeleken met Marqly
