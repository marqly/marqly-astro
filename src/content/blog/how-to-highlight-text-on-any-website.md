---
title: "How to Highlight Text on Any Website (and Actually Keep It)"
...
tags:
  ...
  - "highlighter for websites"
  - "save highlights from web pages"
  - "highlight and take notes on websites"
...
faqs:
  ...
  - q: "Can I see all my highlights in one place?"
    a: "Yes. The Marqly side panel shows every highlight from the page you're on, plus highlights from across your whole library. Clicking a highlight in the panel scrolls the page straight to it. Highlights also sync to the Marqly web app, where they live alongside your bookmarks in one searchable library of links and passages."
  ...
  - q: "Is the Marqly web highlighter free?"
    a: "The extension is free to install and includes bookmarking and tab saving. Highlights and notes are part of Marqly Pro, which costs $72 per year — about $6 a month billed annually. Pro is billed when you upgrade and you can cancel anytime."
...
So the bookmark "works," in the sense that the page opens. Then you're skimming the whole thing, hunting for the line you already found once. Do that a few times and you stop trusting your saved links entirely. It's the same failure mode as [trying to find a saved article when you've forgotten the title](/blog/how-to-find-a-saved-article-you-forgot-the-title-of): the tool stored the container, but your memory works at the level of the contents.
...
1. **Persist on revisit.** Reload the page, come back a month later — the highlight should be sitting exactly where you made it. If highlights only live in a separate app, you've built copy-paste with extra steps.
2. **Multiple colors.** One color means "something here mattered." Several colors let the highlight *say what kind* of thing mattered — evidence versus counterargument versus a quote you'll reuse.
3. **Notes.** The passage is what the author said; the note is why you cared. Future-you needs both, and the note is the half that evaporates fastest from memory.
4. **One searchable home.** Highlights scattered across pages are only useful if they also roll up into a single library you can search — ideally the same library as your bookmarks, so links and passages live together.
5. **Click-to-jump.** Retrieval should end on the page, not in a list. Clicking a highlight in your library should scroll the original page straight to the passage, context intact.
...
1. **Install the Marqly extension.** It's free to install and works on Chrome, Edge, Firefox, and Safari.
2. **Select text on any web page.** A small toolbar appears next to your selection.
3. **Pick one of six highlight colors.** The highlight is applied on the page instantly. Optionally, attach a note — a line about why this passage matters.
4. **Reload or revisit whenever.** Your highlights are restored right on the page, exactly where you made them. Nothing to re-open, nothing to cross-reference.
...
On pricing, plainly: highlights and notes are part of Marqly Pro, which is $72/year — about $6 a month, billed annually. The extension itself is free to install, and the free features (bookmarking, tab saving) stand on their own. Try the highlighter on a real research session once you upgrade; a week is enough to know whether persistent highlights change how you read, and you can cancel anytime.
