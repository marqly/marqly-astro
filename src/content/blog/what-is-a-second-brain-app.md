...
1. **Capture** — save things quickly, from anywhere (web, phone, highlights).
2. **Organize** — structure or tag what you save so it's not chaos.
3. **Retrieve** — and this is the hard one — surface the right thing exactly when you need it.
...
If "a second brain without the maintenance" is what you want, [Marqly](https://app.marqly.com/lp/knowledge-base) is built for exactly this path: import your existing bookmarks, save new things with one click, and then *ask your library* for anything you've read — by meaning, not keywords. It does the organizing so you don't have to.
