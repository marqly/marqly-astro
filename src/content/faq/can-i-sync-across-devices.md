...
- **Saves** — every article, video, and link, from one-click saves to whole tab-saver batches
- **Tags** — both the ones AI applies automatically and any you add yourself
- **Highlights** — text you highlight on pages syncs to your library, and highlights reappear on the page when you revisit it in a browser with the extension
- **Summaries** — AI summaries of your saved articles
