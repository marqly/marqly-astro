...
Email **support@marqly.com** and include:

- The email address on your Marqly account
- The date and amount of the charge
- A short note on why you're asking

Requests are reviewed individually. Charged right after forgetting to cancel? Hit a bug that blocked you from using what you paid for? Say so — context helps. What we won't do is promise a blanket "no-questions-asked X-day guarantee" here that isn't backed by the [terms](/terms).
