...
1. In Chrome, open the Bookmark Manager (`chrome://bookmarks`, or **⋮ → Bookmarks and lists → Bookmark manager**).
2. Click the **⋮** menu inside the Bookmark Manager.
3. Choose **Export bookmarks** and save the HTML file somewhere you can find it.

That one file contains every bookmark and folder in your Chrome profile.

## Step 2: import into Marqly

Sign in at [app.marqly.com](https://app.marqly.com) (free, no card required) and import the HTML file you just exported. Marqly accepts the standard browser bookmark export format — the same one Firefox, Edge, and Safari produce — so this exact workflow also works if you're consolidating bookmarks from several browsers into one library.

For the full walkthrough with screenshots, see [how to import Chrome bookmarks into an AI bookmark manager](/blog/how-to-import-chrome-bookmarks-to-ai).
...
The same import flow handles more than browser bookmarks. Marqly also imports Pocket export files and Raindrop.io collections — see [how do I import from Pocket](/faq/how-do-i-import-from-pocket) and [how do I import from Raindrop](/faq/how-do-i-import-from-raindrop).
