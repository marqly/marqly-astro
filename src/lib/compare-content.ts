...
export function marqlyPairFaqs(marqly: Competitor, b: Competitor): { q: string; a: string }[] {
  ...
  faqs.push({
    q: 'Is Marqly free?',
    a: 'Yes — Marqly has a free tier with no card required: up to 100 bookmarks, all of them readable and keyword-searchable. Pro is $72/year (about $6/month billed annually) or $9/month, billed when you upgrade, and unlocks the AI layer — semantic search, auto-tagging and summaries, AI Q&A over your saves, and chat with YouTube videos.',
  });
