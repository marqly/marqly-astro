...
export function marqlyPairFaqs(marqly: Competitor, b: Competitor): { q: string; a: string }[] {
  ...
  faqs.push({
    q: 'Is Marqly free?',
    a: 'Yes — Marqly has a free tier with no card required. Pro is $48/year (about $4/month billed annually) or $8/month, with a 7-day free trial. Pro unlocks chat with your saves and chat with YouTube videos.',
  });
